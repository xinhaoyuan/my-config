-- A fork of wibox.widget.calandar with a few tweaks.
...
local function create_month(props, date)
    ...
    -- xinhaoyuan@gmail.com: do not force the number of rows
    ...
    for d=1, month_days do
        ...
        if date.day == d then
            flag = "focus"
            -- xinhaoyuan@gmail.com: do not hardcode the focus bold
            -- text = "<b>"..text.."</b>"
        end
        w = props.fn_embed(make_cell(text, props.font), flag, cell_date)
