...
function theme.set_tasklist_brief(brief)
    shared.vars.tasklist_brief = brief
    theme.tasklist_brief = brief
end
theme.set_tasklist_brief(shared.vars.tasklist_brief)
...
do
    ...
    theme.orgenda_icon_p1_todo = orgenda_icon(c_green[1], "clear")
    theme.orgenda_icon_p1_done = orgenda_icon(c_green[1])
    theme.orgenda_icon_p2_todo = orgenda_icon(c_yellow[1], "clear")
    theme.orgenda_icon_p2_done = orgenda_icon(c_yellow[1])
    theme.orgenda_icon_p3_todo = orgenda_icon(c_red[1], "clear")
    theme.orgenda_icon_p3_done = orgenda_icon(c_red[1])
