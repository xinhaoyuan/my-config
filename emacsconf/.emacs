...
(defun my-prefix-default (prefix)
  (interactive "p")
  (let ((keys (this-command-keys-vector)))
    (run-hook-with-args 'my-prefix-undefined-hook keys)
    "")
  )
...
(define-key my-prefix "1" 'my-prefix-default)
(define-key my-prefix "2" 'my-prefix-default)
(define-key my-prefix "3" 'my-prefix-default)
(define-key my-prefix ":" 'my-prefix-default)
(define-key my-prefix "z" 'send-tmux-prefix)
